...
[confuMatrix, mi_event, ma_event] = micro_macro_PR_no0(calcu_label, true_label_event, proportion_each_label_event);
fclose(fID);
...
[confuMatrix_frame, mi_frame, ma_frame] = micro_macro_PR_no0(predict_label_frame, label_t, proportion_each_label);
