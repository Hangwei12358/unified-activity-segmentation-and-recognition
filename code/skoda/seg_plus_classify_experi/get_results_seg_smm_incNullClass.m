...
test_txt_name = 'test1_smm_g1_k10_c1.txt';
n_runs = 6;
% name_of_methods = {'Binseg'; 'BottomUp'; 'Dynp'; 'KCpA'; 'Pelt'; 'Window'; 'proposed_method'}; % ; 'Dynp'
name_of_methods = {'e_divisive'; 'ks_cp3o_delta'; 'e_cp3o_delta'};  % not
% available 
...
for i = 1: num_methods
    for j = 1:n_runs
        ...
        [miF_event, w_maF_event, miF_frame, w_maF_frame] = f_get_results_incNullClass(now_folder_name, test_txt_name);
...
function [miF_event, w_maF_event, miF_frame, w_maF_frame] = f_get_results_incNullClass(now_folder_name, test_txt_name)
...
true_label_event_no0 = true_label_event(find(true_label_event(:,1)~= class0Label));
...
[~, mi_event, ma_event] = micro_macro_PR_no0(predict_label_event, true_label_event, proportion_each_label_event);
...
[~, mi_frame, ma_frame] = micro_macro_PR_no0(predict_label_frame, label_t, proportion_each_label);
