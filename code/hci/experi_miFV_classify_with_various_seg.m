% this script is to generate data for miFV feature extraction and SVM classification under various segmentation
% results.
% learn from experi_SAX_classify_with_various_seg.m
...
for tmpFolderIndn = 1: numRuns   
    ...
    trainSubject = trainEntry(tmpFolderIndn, :);

    tmpFolderInd = int2str(tmpFolderIndn)
    tmpFolderPath = strcat('miFV_', now_method, '_', tmpFolderInd);
...
system('cp /home/hangwei/Documents/segment_Hangwei/code_final/skoda/miFV/CreateGMMCodebook.m ./');
system('cp /home/hangwei/Documents/segment_Hangwei/code_final/skoda/miFV/ExtractFV.m ./');
system('cp /home/hangwei/Documents/segment_Hangwei/code_final/skoda/miFV/InitSystem.m ./');
system('cp /home/hangwei/Documents/segment_Hangwei/code_final/skoda/miFV/predict.mexa64 ./');
system('cp /home/hangwei/Documents/segment_Hangwei/code_final/skoda/miFV/miFV_skoda_imbalanced_has0.m ./');
system('cp /home/hangwei/Documents/segment_Hangwei/code_final/skoda/miFV/predict.mexa64 ./');
system('cp /home/hangwei/Documents/segment_Hangwei/code_final/skoda/miFV/train.mexa64 ./');
